...
const bourneWood = {
	...
	instructions: "Out through the clearing they filmed Gladiator in, down to Waverley Abbey and back up. Something is being filmed today and the unit has half the wood coned off.",
	theme: "trail",
	...
	roads: [
		{
			id: "carpark-searchlight",
			from: "bourne-car-park",
			to: "the-searchlight",
			distanceKm: .5,
			surface: "trail"
		},
		{
			id: "searchlight-bourne",
		...
		},
		{
			id: "moor-cave",
			from: "moor-park",
			to: "mother-ludlams-cave",
			distanceKm: .9,
			surface: "trail"
		},
		{
			id: "cave-waverley",
			from: "mother-ludlams-cave",
			to: "waverley-abbey",
			distanceKm: .9,
			surface: "trail"
		},
	...
	objectives: [
		{
			kind: "start",
			detail: "In the forest car park, arguing about the machine."
		},
		{
			kind: "finish",
			detail: "Back at the cars, having seen nobody famous."
		},
		{
			kind: "distance",
			minKm: 9.5,
			...
			tooLong: {
				...
				message: "{km} km. Somebody kept going to see whether the trucks had moved. They had not."
			},
			tooShort: {
		...
		},
		{
			...
			missed: {
				...
				message: "A run to Bourne Wood that missed the one field anybody has heard of. It has been Germania, Sherwood and Asgard and today it was nothing at all."
			}
		},
		{
			kind: "visit",
			...
			missed: {
				...
				message: "The first Cistercian house in England is twenty minutes away and the club has been round a car park instead."
			}
		},
		{
			kind: "avoid-closed",
			fail: {
				...
				message: "Somebody has taken the group straight through a closed set. Eleven people in club vests are now in a Netflix series set in 1487."
			}
		}
	],
	success: {
		title: "Two Thousand Years In One Loop",
		message: "{km} km, the clearing, the abbey, and not one of you in the background of anything. Somebody is already telling people they were in Gladiator."
	},
	emptyRoute: {
...
//#endregion
//#region src/data/crooksburyHill.ts
/**
...
*/
const crooksburyHill = {
	id: "crooksbury-hill",
	title: "Crooksbury Hill",
	strapline: "It is uphill. In every direction.",
	instructions: "Out from the common over Crooksbury Hill, round under the Hog's Back and home across Hillbury. Seven climbs, and the flat bits are a rumour.",
	theme: "trail",
	...
	objectives: [
		{
			kind: "start",
			detail: "In the top car park, off Suffield Lane."
		},
		{
			kind: "finish",
			detail: "Back at the cars, on the flat, at last."
		},
		{
			kind: "distance",
			minKm: 12,
			...
			tooLong: {
				...
				message: "{km} km. Somebody has added a hill that was not on the list and is describing it as a loop."
			},
			tooShort: {
				title: "That Was The Car Park And A Lane",
				message: "{km} km. Everybody drove forty minutes to run round the bottom of a hill."
			}
		},
		{
			kind: "visit",
			...
			missed: {
				...
				message: "A run to Crooksbury that went round Crooksbury. The trig point is 162 m up and it is not going to come down."
			}
		},
		{
			kind: "visit",
			...
			missed: {
				...
				message: "Hillbury has stood there for two thousand years and the club could not make the detour."
			}
		},
		{
			kind: "climb",
			...
			fail: {
				...
				message: "Somebody has picked a route through Crooksbury that avoids the climbing. It is a remarkable piece of work and it is not the run."
			}
		}
	],
	success: {
	...
	switch (objective.kind) {
		...
		case "climb": {
			...
			return {
				...
				detail: done ? `${climbed} climbed. That will do it.` : `${climbed} so far. ${objective.minHills - climbed} to go.`,
				state: done ? "passed" : "incomplete",
				fail: fillCopy(objective.fail, totalKm),
				stat: {
					label: "Hills climbed",
					value: String(climbed)
				}
			};
		}
		case "no-repeat": {
