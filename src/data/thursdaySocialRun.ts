...
export const thursdaySocialRun: Level = {
  ...
  roads: [
    { id: "obs-rumble", from: "observatory", to: "wellesley-rumble", distanceKm: 0.7 },
    {
      id: "rumble-hanger",
    ...
    { id: "polo-obs", from: "polo-fields", to: "observatory", distanceKm: 0.8 },
    { id: "rumble-pond", from: "wellesley-rumble", to: "geese-pond", distanceKm: 0.65 },
    { id: "pond-tow", from: "geese-pond", to: "towpath", distanceKm: 0.85 },
    { id: "pond-polo", from: "geese-pond", to: "polo-fields", distanceKm: 0.75 },
    {
      id: "hanger-pond",
      from: "the-hanger",
      to: "geese-pond",
    ...
    { id: "medical-passage", from: "medical-centre", to: "back-passage", distanceKm: 0.6 },
    {
      id: "passage-polo",
      from: "back-passage",
      to: "polo-fields",
    ...
    { id: "tesco-canal", from: "big-tesco", to: "canal-bridge", distanceKm: 0.9 },
    {
      id: "hospital-tow",
      from: "hospital-hill",
      to: "towpath",
    ...
    { id: "bush-tesco", from: "private-bush", to: "big-tesco", distanceKm: 1.1 },
  ],
};
