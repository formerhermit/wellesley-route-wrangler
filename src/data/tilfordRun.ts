...
export const tilfordRun: Level = {
  ...
  roads: [
    ...
    { id: "mosque-paddling", from: "mosque", to: "paddling-spot", distanceKm: 1.3, surface: "trail", muddy: true },
    ...
    { id: "sandy-rooty", from: "sandy-track", to: "rooty-bit", distanceKm: 1.2, surface: "trail", muddy: true },
